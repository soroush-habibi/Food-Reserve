...
DB.connect(async (client) => {
    ...
    // const result = await DB.updateEmail("40013131000", "sshh1382", "soroush2@outlook.com").catch(e => console.log(e));
    ...
    // const result = await DB.promote("soroush", "SShh1382@$", "40013131000").catch(e => console.log(e));
    const result = await DB.demote("soroush", "SShh1382@$", "40013131000").catch(e => console.log(e));
    console.log(result);
